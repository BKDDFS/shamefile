...
XFAIL_CASE_INSENSITIVE = "Python-only: Flake8, Bandit, Coverage.py accept case variants but shamefile uses exact match"
XFAIL_WHITESPACE_VARIANT = "Python-only: Flake8, Bandit accept whitespace variants but shamefile uses exact match"
